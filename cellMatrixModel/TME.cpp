...
{
	numberVoxBoxD = p.getNumberVoxBox();
	rhoD = p.getRho();
	rhoCCD = p.getRhoCC();
	...
	w5D = p.getW5();
	CILbD = p.getCILb();
	hetCILaD = p.getHetCILa();
	hetCILbD = p.getHetCILb();
	CILtypeD = p.getCILtype();
	lengthD = p.getLength();
	trajectoryFileNameD = p.getTrajectoryFileName();
	fibreGridLengthD = p.getFibreGridLength();
	boxesToRecordD = p.getBoxesToRecord();
	sourceXD = p.getSourceX();
	sourceYD = p.getSourceY();
	depRateD = p.getDepRate();
	reRateD = p.getReRate();
	degRateD = p.getDegRate();
